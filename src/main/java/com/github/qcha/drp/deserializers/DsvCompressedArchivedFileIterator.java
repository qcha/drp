...
public class DsvCompressedArchivedFileIterator extends DsvIterator {
    public DsvCompressedArchivedFileIterator(@NonNull final InputStream is, @NonNull final DsvPreference preference) throws IOException, ArchiveException, CompressorException {
